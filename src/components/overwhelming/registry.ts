...
export const itemRegistry: OverwhelmingItemConfig[] = [
  ...
  { id: 'notif-instagram', category: 'notification', component: InstagramLikeNotif, weight: 3 },
  { id: 'notif-twitter', category: 'notification', component: TwitterMentionNotif, weight: 2 },
  { id: 'notif-tiktok', category: 'notification', component: TikTokFollowNotif, weight: 3 },
  { id: 'notif-snapchat', category: 'notification', component: SnapchatNotif, weight: 2 },
  { id: 'notif-youtube', category: 'notification', component: YouTubeNotif, weight: 3 },
  { id: 'notif-discord', category: 'notification', component: DiscordNotif, weight: 2 },
  { id: 'notif-email', category: 'notification', component: EmailNotif, weight: 1 },
  ...
  { id: 'react-heart', category: 'reaction', component: HeartReaction, weight: 4 },
  { id: 'react-wow', category: 'reaction', component: WowReaction, weight: 2 },
  { id: 'react-laugh', category: 'reaction', component: LaughReaction, weight: 3 },
  ...
  { id: 'react-fire', category: 'reaction', component: FireReaction, weight: 4 },
  ...
  { id: 'react-hundred', category: 'reaction', component: HundredReaction, weight: 3 },
  { id: 'react-skull', category: 'reaction', component: SkullReaction, weight: 3 },
  ...
  { id: 'video-comedy', category: 'video', component: ComedyVideo, weight: 3 },
  ...
  { id: 'social-story2', category: 'social', component: InstagramStory2, weight: 2 },
  ...
  { id: 'widget-music', category: 'widget', component: MusicWidget, weight: 1 },
];
